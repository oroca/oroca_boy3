...
{
  {GPIOG, GPIO_PIN_13, _DEF_INPUT,  _DEF_HIGH, _DEF_HIGH},  // 0. BAT_CHG
  {GPIOD, GPIO_PIN_5,  _DEF_OUTPUT, _DEF_HIGH, _DEF_HIGH},  // 1. BAT_LOW

  {GPIOD, GPIO_PIN_7,  _DEF_OUTPUT, _DEF_HIGH, _DEF_HIGH},  // 2. LCD_BL_EN
  {GPIOC, GPIO_PIN_13, _DEF_OUTPUT, _DEF_HIGH, _DEF_HIGH},  // 3. LCD_RST

  {GPIOI, GPIO_PIN_0,  _DEF_INPUT,  _DEF_HIGH, _DEF_HIGH},  // 4. SDCARD_CD

  {GPIOI, GPIO_PIN_5,  _DEF_OUTPUT, _DEF_HIGH, _DEF_HIGH},  // 5. ESP32_RST
  {GPIOI, GPIO_PIN_8,  _DEF_OUTPUT, _DEF_HIGH, _DEF_HIGH},  // 6. ESP32_BOOT

  {GPIOH, GPIO_PIN_3,  _DEF_OUTPUT, _DEF_HIGH, _DEF_HIGH},  // 7. SPK_EN
};
