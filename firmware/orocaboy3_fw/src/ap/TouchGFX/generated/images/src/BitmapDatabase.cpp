// 4.12.2 dither_algorithm=2 alpha_dither=yes layout_rotation=0 opaque_image_format=RGB565 non_opaque_image_format=ARGB8888 section=ExtFlashSection extra_section=ExtFlashSection generate_png=no 0xd9f44d1a
...
extern const unsigned char _dark_buttons_round_edge_small_pressed[]; // BITMAP_DARK_BUTTONS_ROUND_EDGE_SMALL_PRESSED_ID = 4, Size: 170x60 pixels
extern const unsigned char _dark_pageindicator_dot_indicator_small_highlight[]; // BITMAP_DARK_PAGEINDICATOR_DOT_INDICATOR_SMALL_HIGHLIGHT_ID = 5, Size: 15x15 pixels
extern const unsigned char _dark_pageindicator_dot_indicator_small_normal[]; // BITMAP_DARK_PAGEINDICATOR_DOT_INDICATOR_SMALL_NORMAL_ID = 6, Size: 15x15 pixels
extern const unsigned char _doom[]; // BITMAP_DOOM_ID = 7, Size: 200x95 pixels
extern const unsigned char _fmsx[]; // BITMAP_FMSX_ID = 8, Size: 200x72 pixels
extern const unsigned char _orocaboy1[]; // BITMAP_OROCABOY1_ID = 9, Size: 24x24 pixels
extern const unsigned char _orocaboy2[]; // BITMAP_OROCABOY2_ID = 10, Size: 24x24 pixels
extern const unsigned char _orocaboy3[]; // BITMAP_OROCABOY3_ID = 11, Size: 24x24 pixels
extern const unsigned char _orocaboy4[]; // BITMAP_OROCABOY4_ID = 12, Size: 24x24 pixels
